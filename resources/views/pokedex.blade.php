        ...
        @foreach($pokemons as $pokemon)
            <div class="col">
                <div class="card h-100">
                    <!-- Gambar Pokémon (jika tidak ada, tampilkan placeholder) -->
                    ...
                    <div class="card-body">
                        <!-- ID Pokémon dengan format padding -->
                        <h7 class="card-title">
                            <span class="fw-bold">#{{ str_pad($pokemon->id, 4, '0', STR_PAD_LEFT) }}</span>
                        </h7>
                        <!-- Nama Pokémon (dapat diklik menuju halaman detail Pokémon) -->
                        <h3>
                        ...
                        <p class="card-text">
                            <!-- Tipe Pokémon dalam bentuk badge -->
